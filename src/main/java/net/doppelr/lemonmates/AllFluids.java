...
import static net.doppelr.lemonmates.LemonMates.REGISTRATE;


public class AllFluids {
    /*public static final FluidEntry<BaseFlowingFluid.Flowing> WATERMELON_LEMONADE_FLUID =
            REGISTRATE.standardFluid("watermelon_lemonade_fluid",
                            )
    ...
    /*public static void registerFluidInteractions() {
        ...
        if (estrogenFluid != Fluids.EMPTY) {
            FluidInteractionRegistry.addInteraction(estrogenFluid.getFluidType(), new FluidInteractionRegistry.InteractionInformation(
                    WATERMELON_LEMONADE_FLUID.get().getFluidType(),
                    fluidState -> BLOCK
            ));
        ...
        FluidInteractionRegistry.addInteraction(net.mifort.testosterone.fluids.AllFluids.ESTRONE_FLUID.getType(), new FluidInteractionRegistry.InteractionInformation(
                TESTOSTERONE_FLUID.get().getFluidType(),
                fluidState -> BLOCK
        ));

        FluidInteractionRegistry.addInteraction(TESTOSTERONE_FLUID.get().getFluidType(), new FluidInteractionRegistry.InteractionInformation(
                net.mifort.testosterone.fluids.AllFluids.ESTRONE_FLUID.getType(),
                fluidState -> BLOCK
        ));
