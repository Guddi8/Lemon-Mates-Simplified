...
public class AllFluids {
    ...
    static {
        REGISTRATE.setCreativeTab(ModCreativeModeTabs.LEMONMATES_TAB);
    }

    public static final FluidEntry<BaseFlowingFluid.Flowing> WATERMELON_LEMOANDE =
            REGISTRATE.standardFluid("watermelon_lemonade",
                    SolidRenderedPlaceableFluidType.create(0x010101, () -> 1f / 32F))
