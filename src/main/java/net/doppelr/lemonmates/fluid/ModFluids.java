...
import net.doppelr.lemonmates.fluid.BaseFluidType;
...
public class ModFluids {
    ...
    // Finished Fluids
    // Citron final
    public static final DeferredHolder<FluidType, FluidType> CITRON_LEMONADE_FLUID = FLUID_TYPES.register("citron_lemonade_fluid", () -> new BaseFluidType("citron_lemonade_liquid_still","citron_lemonade_liquid_flowing", FluidType.Properties.create().descriptionId("Citron Lemonade")));
    ...
    // Orange final
    public static final DeferredHolder<FluidType, FluidType> ORANGE_LEMONADE_FLUID = FLUID_TYPES.register("orange_lemonade_fluid", () -> new BaseFluidType("orange_lemonade_liquid_still","orange_lemonade_liquid_flowing", FluidType.Properties.create().descriptionId("Orange Lemonade")));
    ...
    // Raspberry final
    public static final DeferredHolder<FluidType, FluidType> RASPBERRY_LEMONADE_FLUID = FLUID_TYPES.register("raspberry_lemonade_fluid", () -> new BaseFluidType("raspberry_lemonade_liquid_still","raspberry_lemonade_liquid_flowing", FluidType.Properties.create().descriptionId("Raspberry Lemonade")));
    ...
    // Summermix final
    public static final DeferredHolder<FluidType, FluidType> SUMMERMIX_LEMONADE_FLUID = FLUID_TYPES.register("summermix_lemonade_fluid", () -> new BaseFluidType("summermix_lemonade_liquid_still","summermix_lemonade_liquid_flowing", FluidType.Properties.create().descriptionId("Summer-Mix Lemonade")));
    ...
    // Watermelon final
    public static final DeferredHolder<FluidType, FluidType> WATERMELON_LEMONADE_FLUID = FLUID_TYPES.register("watermelon_lemonade_fluid", () -> new BaseFluidType("watermelon_lemonade_liquid_still","watermelon_lemonade_liquid_flowing", FluidType.Properties.create().descriptionId("Watermelon Lemonade")));
    ...
    // Orange mixed
    public static final DeferredHolder<FluidType, FluidType> MIXED_ORANGE_LEMONADE_FLUID = FLUID_TYPES.register("mixed_orange_lemonade_fluid", () -> new BaseFluidType("mixed_orange_lemonade_liquid_still","mixed_orange_lemonade_liquid_flowing", FluidType.Properties.create().descriptionId("Orange Lemonade")));
    ...
    // Raspberry mixed
    public static final DeferredHolder<FluidType, FluidType> MIXED_RASPBERRY_LEMONADE_FLUID = FLUID_TYPES.register("mixed_raspberry_lemonade_fluid", () -> new BaseFluidType("mixed_raspberry_lemonade_liquid_still","mixed_raspberry_lemonade_liquid_flowing", FluidType.Properties.create().descriptionId("Raspberry Lemonade")));
    ...
    // Summermix mixed
    public static final DeferredHolder<FluidType, FluidType> MIXED_SUMMERMIX_LEMONADE_FLUID = FLUID_TYPES.register("mixed_summermix_lemonade_fluid", () -> new BaseFluidType("mixed_summermix_lemonade_liquid_still","mixed_summermix_lemonade_liquid_flowing", FluidType.Properties.create().descriptionId("Summer-Mix Lemonade")));
    ...
    // Watermelon mixed
    public static final DeferredHolder<FluidType, FluidType> MIXED_WATERMELON_LEMONADE_FLUID = FLUID_TYPES.register("mixed_watermelon_lemonade_fluid", () -> new BaseFluidType("mixed_watermelon_lemonade_liquid_still","mixed_watermelon_lemonade_liquid_flowing", FluidType.Properties.create().descriptionId("Watermelon Lemonade")));
